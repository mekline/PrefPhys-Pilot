...
QUESTION: FOR PATRICK: I'd like to be able to specify a planned comparison of these orderings, but I'm not sure how! (IE if I'd like to compare the model fits to something like "means are at [1 1 1 0.5 0.5 0.5]", I don't know how to implement that prediction.)
